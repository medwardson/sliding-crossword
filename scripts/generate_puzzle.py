...
# https://github.com/ngparker/squareword_gen
#
# This code was taken from the above repository and modified to suit the needs of the project. The original code was written by Nathan Parker.
...
def GenSubSquares(word_trie, start_word, column_trie_nodes=[], log_prefix=[]):
    """Generate all the partial squares that have start_word at the top, recursively.
      ...
      column_trie_nodes for sub-calls.
...
def main():
    ...
    word_trie_n_1 = WordTrie(working_words_n_1)
